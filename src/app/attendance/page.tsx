...
export default async function AttendancePage({ searchParams }: AttendancePageProps) {
  ...
  const activeModal: ModalType | null = modalParam === "rekap-export" ? "rekap-export" : null;
    ...
    <div className="space-y-4">
      ...
      <section className="grid gap-4 xl:grid-cols-[340px_1fr]">
        <article className="panel p-5">
          <h2 className="text-lg font-semibold text-slate-900">Input Absensi</h2>
          <p className="text-xs text-slate-500">Form sederhana untuk tambah data harian pekerja.</p>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Pilih periode dan project. Pemilihan pekerja dilakukan di tabel data absensi.
              </p>
            </div>
      ...
      <section className="panel p-5">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Centang pekerja yang ingin direkap, lalu klik tombol rekap.
            </p>
          </div>
                        ...
                        {!item.payrollPaid ? (
                          <form action={confirmPayrollPaidAction}>
                            ...
                            <input
                              ...
                              value={toDateOnly(item.attendanceDate)}
                            />
      ...
      {activeModal ? (
        <div className="modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <section className="modal-card panel relative z-10 w-full max-w-2xl p-5">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-slate-900">Rekap & Export Pekerja</h2>
              <Link
                href={closeModalHref}
                data-ui-button="true"
